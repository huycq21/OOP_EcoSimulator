...
public class Wolf extends Carnivore {
    ...
    public Wolf(Vector2D position) {
        ...
        SurvivalStrategy packLogic = new PackFlockingStrategy(hunter, 0.30, 1.9);
        
        // Ưu tiên nhặt xác hơn là tự đi săn cho đỡ tốn sức
        SurvivalStrategy scavenger = new ScavengerStrategy(packLogic);
        
        // Vỏ bọc an toàn ngoài cùng: Gặp Hổ, Gấu (Sức mạnh > 128.0) thì vẫn phải chạy!
